...
export default function adminSidebarComponents() {
  return (
    <>
       <div className="w-[80px] h-screen bg-gray-800 pt-10">
            <div className="w-full  text-white flex flex-col justify-center items-center">
                <NavLink className="SideBarLink">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-shop-window" viewBox="0 0 16 16">
                ...
                <NavLink className="Sgit sideBarLink">
