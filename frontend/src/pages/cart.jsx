...
export default function cart() {
  ...
  return (
    <div className="grid justify-items-stretch">  
        <div className="flex justify-self-center w-5/6 space-x-3 max-laptop:space-x-0 ">
             <div className="w-[75%]   max-laptop:w-[90%] ">
            ...
            <div className="w-[24%] min-w-[300px] max-h-[21rem] bg-white shadow-lg rounded p-5 max-laptop:w-full  max-laptop:top-[160px] max-laptop:fixed max-laptop:left-[0] max-laptop:p-2">
